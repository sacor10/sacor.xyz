          ...
          <tr>
            <td bgcolor="#000000">
              <font face="Comic Sans MS" size="2" color="#FFFFFF">
                <b className="cyan">X:</b> x.com links
                <br />
                <b className="lime">Twitter:</b> twitter.com links
                <br />
                <b className="yellow">Posts:</b> /status/&lt;id&gt; links
                <br />
                <br />
                Public post videos only. Image-only posts will politely bounce.
              </font>
            </td>
          </tr>
        </tbody>
          ...
          <tr>
            <td bgcolor="#000000">
              <font face="Comic Sans MS" size="2" color="#00FF00">
                Posts with multiple videos download as one ZIP with up to 20 public videos inside.
...
export default function XDownloaderPage() {
  ...
  const submit = async (event) => {
    ...
    if (!targetUrl) {
      setStatus('error')
      setMessage('Paste a public X/Twitter post URL first.')
      return
    }
    ...
    <>
      <center>
        <font face="Impact" size="6" color="#FF00FF" className="hero-glow">
          <span className="blink">~*~ X VIDEO DOWNLOADER ~*~</span>
        </font>
      </center>
          ...
          <tr>
            <td>
              <font face="Comic Sans MS" size="3" color="#FFFFFF">
                Paste a public X/Twitter post URL and this thing grabs every public video it can find
                in one shot. Single videos come down as MP4; multi-video posts come down as one ZIP.
              </font>
            </td>
          </tr>
        </tbody>

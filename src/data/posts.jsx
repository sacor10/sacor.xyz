...
export const posts = [
  {
    ...
    thumbBorder: '#FF00FF',
    thumb: '/generated-assets/thumb-ytmp4-v2.png',
    link: '/ytmp4',
  },
  {
    slug: 'slc-lan-party',
    ...
    thumbBorder: '#00FFFF',
    thumb: '/generated-assets/thumb-slc-lan-v2.png',
    body: (
  ...
  },
  {
    ...
    thumbBorder: '#00FF00',
    thumb: '/generated-assets/thumb-90s-snacks-v2.png',
    body: (
      <font face="Comic Sans MS" size="3" color="#FFFFFF">
        <i>Post coming soon!!! Sacor is writing this one up.</i>
        <br />
  ...
  },
  {
    ...
    thumbBorder: '#FFFF00',
    thumb: '/generated-assets/thumb-stop-warning-v2.png',
    body: (
      <font face="Comic Sans MS" size="3" color="#FFFFFF">
        <i>Post coming soon!!! Sacor is writing this one up.</i>
        <br />
